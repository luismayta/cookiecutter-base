...
<!-- Title: Contributing GitFlow CookiecutterBase -->
...
To contribute to cookiecutter-base project on [GitHub](https://github.com/luismayta/cookiecutter-base), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/cookiecutter-base/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to cookiecutter-base project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/cookiecutter-base.git
```

Now your **upstream** points to **luismayta/cookiecutter-base**.
...
git fetch upstream # assuming upstream is luismayta/cookiecutter-base
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/cookiecutter-base/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
